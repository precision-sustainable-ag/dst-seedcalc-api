const { DEBUG, INFO, WARNING, CRITICAL, Logger } = require('../logging/Logger');
const { SingleLogger } = require('../logging/SingleLogger');
const { DailyLogger } = require('../logging/DailyLogger');
const { SlackLogger } = require('../logging/SlackLogger');
